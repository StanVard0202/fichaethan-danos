...
municaomagnum2 = localStorage.getItem("municaomagnum2")
...
var html=""
    ...
    html+="<tr><td>Magnum.44</td><td>Armas/Pistola</td><td>1d10+1d4+2</td><td>"+ municaomagnum +" <button onclick='atirarmagnum()'>Tiro</button><button onclick='racarregarmagnum()'>Recarregar</button></td><td>1(3)</td><td>15m</td><td>1</td><td>X</td></tr>"

    html+="<tr><td>Arma de plasma</td><td>Armas/Pistola</td><td>1d10+1d4+2(+2 de plasma)</td><td>"+ municaomagnum2 +" <button onclick='atirarmagnum2()'>Tiro</button><button onclick='racarregarmagnum2()'>Recarregar</button></td><td>1(3)</td><td>15m</td><td>1</td><td>X</td></tr>"
...
function atirarmagnum2(){
  
    municaomagnum2 = municaomagnum2 - 1
    localStorage.setItem("municaomagnum2",municaomagnum2)
    
    html(origem3)
    }
    
    function racarregarmagnum2(){
        municaomagnum2 = municaomagnum2 + 6
    localStorage.setItem("municaomagnum2",municaomagnum2)
